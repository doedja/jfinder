...
<span class="tooltip-trigger" class:active data-position={position} role="button" tabindex="0" onclick={handleClick}>
...
<style>
  ...
  .tooltip-trigger[data-position="top"].active .tooltip-content {
  ...
  .tooltip-trigger[data-position="bottom"].active .tooltip-content {
    transform: translateX(-50%) translateY(0);
  }
  ...
  .tooltip-trigger[data-position="left"].active .tooltip-content {
  ...
  .tooltip-trigger[data-position="right"].active .tooltip-content {
    transform: translateY(-50%) translateX(0);
  }

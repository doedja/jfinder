<script lang="ts">
  ...
  import UnifiedCapabilities from '$lib/components/UnifiedCapabilities.svelte';
</script>

<svelte:head>
  <title>JFinder — Features</title>
</svelte:head>
...
<main class="main">
  ...
  <div class="content container">
    <div class="page-header">
      <a href="/" class="back-link">&larr; Back to JFinder</a>
      <h1 class="page-title">Features</h1>
      <p class="page-subtitle">Explore all features available in JFinder</p>
    </div>
